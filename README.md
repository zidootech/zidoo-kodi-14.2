...
This branch modify for AllWinner H3 platform base on Kodi-Helix.
The implement of codec is same as Amlogic. You need a library libvrender.so
You can find it in this path "lib/libvrender". 
Package it into apk or push it system library path on your device.

Zidoo X1 is a good choice for you to run the apk. 
