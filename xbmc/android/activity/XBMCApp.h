...
public:
  ...
  static int  SetDisplayOutput(int format);
  static int  GetDisplayOutput();
  static void  SetPreviousDisplayOutput(int output);
  static int  GetPreviousDisplayOutput();  
  static int GetDPI();
protected:
