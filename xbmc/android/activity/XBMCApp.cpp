...
int CXBMCApp::m_preDisplayOutput = -1;
...
void CXBMCApp::onResume()
{
  ...
  CApplicationMessenger::Get().Resume();
}
...
void CXBMCApp::onPause()
{
  ...
  CApplicationMessenger::Get().Pause();
  // Restore volume
...
void CXBMCApp::onStop()
{
  ...
  int preOutput =  CXBMCApp::GetPreviousDisplayOutput();
  int curOutput = CXBMCApp::GetDisplayOutput();
  android_printf("CXBMCApp::onStop, previous Output = 0x%x", preOutput);
  if ((preOutput != -1) && (preOutput != curOutput))
  {
     android_printf("CXBMCApp::onStop, SetDisplayOutput (0x%x) -> (0x%x)", curOutput, preOutput);
     CXBMCApp::SetPreviousDisplayOutput(-1);
     CXBMCApp::SetDisplayOutput(preOutput);
     sleep(3);
  }  
}
...
int CXBMCApp::GetDisplayOutput()
{
  return 0;
}

int CXBMCApp::SetDisplayOutput(int format)
{
  return 0;
}

int CXBMCApp::GetPreviousDisplayOutput()
{
  return m_preDisplayOutput;
}

void CXBMCApp::SetPreviousDisplayOutput(int output) 
{
  m_preDisplayOutput = output;
}