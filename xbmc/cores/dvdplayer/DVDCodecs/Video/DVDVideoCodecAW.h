...
class CDVDVideoCodecAW : public CDVDVideoCodec
{
public:
  CDVDVideoCodecAW();
  virtual ~CDVDVideoCodecAW();
  ...
  virtual void SetAppState(int state);
  virtual void SetStreamInputFormat(const char *name);
